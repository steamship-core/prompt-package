...
`)
  ...
  from the official NLUDB repo or a GitHub URL. The URL can use
...
async function run() {
    ...
    if (!valid) {
        console.error(`Could not create a project called ${chalk.red(`"${projectName}"`)} because of naming restrictions:`);
