...
// import { ClassifyRequest, ClassifyResult, CreateClassifierRequest } from './types/classifier';
...
//     const classifier = await nludb.createClassifier({save: false, model: ClassifierModel.HF_ZERO_SHOT_LBART})
...
//   const c1 = await nludb.createClassifier({save: false, model: ClassifierModel.HF_ZERO_SHOT_LBART})
